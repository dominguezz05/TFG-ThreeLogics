...
export default function Hero() {
  return (
    <section className="relative w-full h-screen flex items-center bg-black px-6 md:px-10">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left md:ml-12">
        <motion.h1
        ...
        <p className="mt-4 text-gray-300 text-base sm:text-lg font-fira">
          ThreeLogics mejora la eficiencia y control en la logística empresarial.
        </p>
        <div className="mt-6 flex flex-col sm:flex-row gap-4 sm:gap-6 items-center sm:items-start">
          <motion.button
            whileHover={{
              scale: 1.1,
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
        className="absolute right-0 top-0 h-full w-full md:w-[45vw] hidden sm:flex justify-end"
      >
        {/* Degradado lateral */}
